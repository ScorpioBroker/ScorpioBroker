package eu.neclab.ngsildbroker.registrysubscriptionmanager.controller;
  ...
  eu.neclab.ngsildbroker.commons.serialization.DataSerializer;
import eu.neclab.ngsildbroker.registrysubscriptionmanager.service.RegistrySubscriptionService; 
  ...
  @MockBean private RegistrySubscriptionService registrySubscriptionService;
 ...
 /**
	...
	public void createRegistrySubscriptionEntityTest() {
		...
		try {
			...
			mockMvc.perform(post("/ngsi-ld/v1/csourceSubscriptions").contentType(AppConstants.NGB_APPLICATION_JSON)
