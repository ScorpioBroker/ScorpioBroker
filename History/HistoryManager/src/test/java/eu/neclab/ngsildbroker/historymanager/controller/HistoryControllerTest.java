 ...
 /**
  ...
  public void createTemporalEntityTest()
	{
		try {
 			when(historyService.createEntry(any(), any())).thenReturn("urn:ngsi-ld:testunit:151");

			ResultActions resultAction = 	mockMvc.perform(post("/ngsi-ld/v1/temporal/entities/").contentType(AppConstants.NGB_APPLICATION_JSONLD)
 ...
 /**
	...
	public void createTemporalEntityBadRequestTest() {
		try {
			when(historyService.createEntry(any(), any())).thenThrow(new ResponseException(ErrorType.BadRequestData,"Bad Request Data."));
			ResultActions resultAction =	mockMvc.perform(post("/ngsi-ld/v1/temporal/entities/").contentType(AppConstants.NGB_APPLICATION_JSONLD)
					.accept(AppConstants.NGB_APPLICATION_JSONLD).content(temporalPayload))
 ...
 /**
  ...
  @Test
	public void createTemporalEntityInternalServerErrorTest() {
		try {
			when(historyService.createEntry(any(), any())).thenThrow(new ResponseException(ErrorType.InternalError, "Internal error"));
			ResultActions resultAction =mockMvc.perform(post("/ngsi-ld/v1/temporal/entities/").contentType(AppConstants.NGB_APPLICATION_JSONLD)
					.accept(AppConstants.NGB_APPLICATION_JSONLD).content(temporalPayload))
	  ...
	  try {
		  ...
		  QueryResult result = mock(QueryResult.class);
			...
			ResultActions resultAction = mockMvc.perform(
					get("/ngsi-ld/v1/temporal/entities?type=Test1")
  ...
  public void getTemporalEntitiesNotFoundTest()throws Exception{
	  try {
		  ...
		  QueryResult result = mock(QueryResult.class);
			when(historyService.getData(any(), any(), any(), any(), any())).thenThrow(new ResponseException(ErrorType.TenantNotFound,"Tenant not found."));
  ...
  public void getQueryForEntitiesBadRequestTest()throws Exception{
	  try {
		  ...
		  QueryResult result = mock(QueryResult.class);
			when(historyService.getData(any(), any(), any(), any(), any())).thenThrow(new ResponseException(ErrorType.BadRequestData,"invalid query"));
	...
	public void addAttrib2TemopralEntityTest()throws Exception {
		...
		ResultActions resultAction =	mockMvc.perform(post("/ngsi-ld/v1/temporal/entities/urn:ngsi-ld:testunit:151/attrs/")
 ...
 /**
  ...
  @Test
	public void addAttrib2TemopralEntityInternalServerErrorTest() {
		try {
			UpdateResult result = mock(UpdateResult.class);
			when(historyService.appendToEntry(any(), any(), any(), any())).thenThrow(new ResponseException(ErrorType.InternalError,"Internal error"));
...
public void addAttrib2TemopralEntityBadRequestTest() {
	try {
		UpdateResult result = mock(UpdateResult.class);
		when(historyService.appendToEntry(any(), any(), any(), any())).thenThrow(new ResponseException(ErrorType.BadRequestData,"Bad Request Data."));
...
public void deleteTemporalEntityByAttrTest() {
	...
	ResultActions resultAction =	mockMvc.perform(MockMvcRequestBuilders.delete("/ngsi-ld/v1/temporal/entities/{entityId}/attrs/{attrId}",
  ...
  /**
	...
	public void deleteTemporalEntityByAttrInternalServerErrorTest()throws Exception {
		try {
 			when(historyService.delete(any(), any(), any(), any(),any())).thenThrow(new ResponseException(ErrorType.InternalError,"Internal error"));
  ...
  @Test
	public void deleteTemporalEntityByAttrBadRequestTest() {
		try {
 			when(historyService.delete(any(), any(), any(), any(),any())).thenThrow(new ResponseException(ErrorType.BadRequestData,"Bad Request Data."));
  ...
  /**
	...
	public void deleteTemporalEntityByAttrResourceNotFoundTest() {
		try {
		when(historyService.delete(any(), any(), any(), any(),any())).thenThrow(new ResponseException(ErrorType.NotFound,"Resource not found."));
...
public void deleteTemporalEntityByIdTest()throws Exception {
	...
	try {
		ResultActions resultAction =mockMvc.perform(
				MockMvcRequestBuilders.delete("/ngsi-ld/v1/temporal/entities/{entityId}", "urn:ngsi-ld:testunit:151")
						.contentType(AppConstants.NGB_APPLICATION_JSONLD))
				.andExpect(status().isNoContent());
...
public void deleteTemporalEntityByIdNotFoundTest()throws Exception {
	List<Object> linkHeaders = new ArrayList<>();
	when(historyService.deleteEntry(any(), any())).thenThrow(new ResponseException(ErrorType.NotFound,"Resource not found."));
	try {
		ResultActions resultAction =mockMvc.perform(
				MockMvcRequestBuilders.delete("/ngsi-ld/v1/temporal/entities/{entityId}", "urn:ngsi-ld:testunit:151")
						.contentType(AppConstants.NGB_APPLICATION_JSONLD))
 ...
 /**
	...
	public void deleteTemporalEntityInternalServerError() {
		...
		//	Mockito.doThrow(new Exception()).when(historyService).delete(any(), any(), any(), any(), any());
			when(historyService.deleteEntry(any(), any())).thenThrow(new ResponseException(ErrorType.InternalError, "Internal error"));
  ...
  /**
	...
	public void deleteTemporalEntityBadRequest() {
		try {
			when(historyService.deleteEntry(any(), any())).thenThrow(new ResponseException(ErrorType.BadRequestData,"Bad Request Data."));
