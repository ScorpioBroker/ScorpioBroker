...
public class HistoryServiceTest {
	...
	public void deleteTemporalByIdTest() {
		...
		try {
			Mockito.doReturn("https://uri.etsi.org/ngsi-ld/default-context/airQualityLevel").when(paramsResolver)
					.expandAttribute(any(), any());
			historyService.delete(ArrayListMultimap.create(), "urn:ngsi-ld:testunit:151", "airQualityLevel", null,
					linkHeaders);
