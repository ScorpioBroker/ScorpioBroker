...
import eu.neclab.ngsildbroker.historymanager.config.ConsumerChannel;
import eu.neclab.ngsildbroker.historymanager.config.ProducerChannel;


@SpringBootApplication
@EnableBinding({ ConsumerChannel.class, AtContextProducerChannel.class,ProducerChannel.class })
