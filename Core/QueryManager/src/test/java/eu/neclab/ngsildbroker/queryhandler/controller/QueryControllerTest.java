...
// 
  ...
  entitiesBadRequest = new ArrayList<String>(Arrays.asList());
	...
	@Test
	  ...
	  ResultActions resultAction=	mockMvc.perform(get("/ngsi-ld/v1/entities/{entityId}", "urn:ngsi-ld:Vehicle:A101")
				.accept(AppConstants.NGB_APPLICATION_JSON)).andExpect(status().isOk())
				.andExpect(jsonPath("$.id").value("urn:ngsi-ld:Vehicle:A101"));
	...
	public void getEntityByIdNotFoundTest() throws Exception {
		try {
			...
			QueryResult result = new QueryResult(entities, null, ErrorType.None, -1, true);
			  result.setActualDataString(entities);
			  when(queryService.getData(any(), any(), any(), any(), any())).thenThrow(new ResponseException(ErrorType.NotFound, "Resource not found.")).thenReturn(result);

			ResultActions resultAction = mockMvc
					.perform(get("/ngsi-ld/v1/entities/{entityId}", "urn:ngsi-ld:Vehicle:A101").accept(AppConstants.NGB_APPLICATION_JSON))
	...
	@Test
	  ...
	  result.setActualDataString(entities);
	  when(queryService.getData(any(), any(), any(), any(), any())).thenReturn(result);
	  ResultActions resultAction=	mockMvc.perform(get("/ngsi-ld/v1/types")
				.accept(AppConstants.NGB_APPLICATION_JSON)).andExpect(status().isOk())
				.andExpect(jsonPath("$.id").value("urn:ngsi-ld:Vehicle:A101"));
		MvcResult mvcResult = resultAction.andReturn();
		MockHttpServletResponse response = mvcResult.getResponse();
	...
	@Test
	  ...
	  result.setActualDataString(entities);
	  when(queryService.getData(any(), any(), any(), any(), any())).thenReturn(result);
	  ResultActions resultAction=	mockMvc.perform(get("/ngsi-ld/v1/types/{entityType}","Vehicle")
				.accept(AppConstants.NGB_APPLICATION_JSON)).andExpect(status().isOk())
				.andExpect(jsonPath("$.id").value("urn:ngsi-ld:Vehicle:A101"));
		MvcResult mvcResult = resultAction.andReturn();
		MockHttpServletResponse response = mvcResult.getResponse();
	...
	@Test
	  ...
	  result.setActualDataString(entities);
	  when(queryService.getData(any(), any(), any(), any(), any())).thenReturn(result);
	  ResultActions resultAction=	mockMvc.perform(get("/ngsi-ld/v1/attributes")
				.accept(AppConstants.NGB_APPLICATION_JSON)).andExpect(status().isOk())
				.andExpect(jsonPath("$.id").value("urn:ngsi-ld:Vehicle:A101"));
		MvcResult mvcResult = resultAction.andReturn();
		MockHttpServletResponse response = mvcResult.getResponse();
	...
	@Test
	  ...
	  result.setActualDataString(entities);
	  when(queryService.getData(any(), any(), any(), any(), any())).thenReturn(result);
	  ResultActions resultAction=	mockMvc.perform(get("/ngsi-ld/v1/attributes/{attribute}","brandName")
				.accept(AppConstants.NGB_APPLICATION_JSON)).andExpect(status().isOk());
	...
	public void getAttributeByAttrNotFoundTest() throws Exception {
		try {
			...
			ResultActions resultAction = mockMvc
					.perform(get("/ngsi-ld/v1/attributes/{attribute}", "brandName").accept(AppConstants.NGB_APPLICATION_JSON))
					.andExpect(status().isNotFound());
