 ...
 * import org.mockito.MockitoAnnotations; import org.mockito.Spy; import
 * org.powermock.core.classloader.annotations.PowerMockIgnore; import
 * org.powermock.modules.junit4.PowerMockRunner; import
 * org.powermock.modules.junit4.PowerMockRunnerDelegate; import
 ...
 * 
 * import eu.neclab.ngsildbroker.commons.datatypes.EntityDetails; import
 ...
 * eu.neclab.ngsildbroker.entityhandler.config.EntityProducerChannel; import
 * eu.neclab.ngsildbroker.entityhandler.config.EntityTopicMap;
 * 
 * //@RunWith(SpringRunner.class) //@SpringBootTest //Set powemock runner
 * 
 * @RunWith(PowerMockRunner.class) // Delegate to Spring
 * 
 * @PowerMockRunnerDelegate(SpringRunner.class)
 * 
 * @PowerMockIgnore({ "javax.management.*" }) public class EntityServiceTest {
 * 
 * @Mock KafkaOps operations;
 * 
 * @MockBean private ObjectMapper objectMapper;
 * 
 * @MockBean private EntityTopicMap entityTopicMap;
 * 
 * @Mock EntityProducerChannel entityProducerChannel;
 * 
 * @InjectMocks
 * 
 * @Spy private EntityService entityService;
 * 
 * @Rule public ExpectedException thrown = ExpectedException.none();
 * 
 * String updatePayload; String appendPayload; String entityPayload; String
 * updatePartialAttributesPayload; String updatePartialDefaultAttributesPayload;
 * JsonNode updateJsonNode; JsonNode appendJsonNode; JsonNode blankNode;
 * JsonNode payloadNode; JsonNode updatePartialAttributesNode; JsonNode
 * updatePartialDefaultAttributesNode;
 * 
 * @Before public void setUp() throws Exception {
 * MockitoAnnotations.initMocks(this);
 * ReflectionTestUtils.setField(entityService, "appendOverwriteFlag",
 * "noOverwrite"); ObjectMapper objectMapper=new ObjectMapper();
 * 
 * //@formatter:off
 * 
 ...
 * updatePartialAttributesNode=objectMapper.readTree(
 * updatePartialAttributesPayload);
 * updatePartialDefaultAttributesNode=objectMapper.readTree(
 * updatePartialDefaultAttributesPayload); }
 * 
 * @After public void tearDown() { updatePayload = null; appendPayload=null;
 * entityPayload=null; updatePartialAttributesPayload=null;
 ...
 *//**
	 ...
	 */
/*
 * @Test public void createMessageTest(){ try { //TODO redo logic has changed no
 * quick fix JsonNode jsonNode = Mockito.mock(JsonNode.class);
 ...
 * Assert.assertEquals(id, "urn:ngsi-ld:Vehicle:A103"); //verify(entityService,
 * times(1)).getKeyValueEntity(any()); }catch( Exception ex) { Assert.fail(); }
 * 
 * }
 * 
 *//**
	 ...
	 */
/*
 * @Test public void createMessageThrowsAlreadyExistTest() throws
 * ResponseException, Exception { thrown.expect(ResponseException.class);
 * thrown.expectMessage("Already exists."); JsonNode jsonNode =
 ...
 * Mockito.doReturn(true).when(operations).pushToKafka(any(), any(), any());
 * Mockito.doThrow(new
 * ResponseException(ErrorType.AlreadyExists)).when(entityService).createMessage
 * (any(), any()); entityService.createMessage(any(), entityPayload);
 ...
 *//**
	 ...
	 */
/*
 * @Test public void updateMessageTest() throws Exception{
 * 
 * EntityDetails entityDetails=Mockito.mock(EntityDetails.class); byte[]
 * messageByte=entityPayload.getBytes(); JsonNode resultJson =
 * objectMapper.createObjectNode(); UpdateResult updateResult = new
 * UpdateResult(updateJsonNode, resultJson); updateResult.setStatus(true);
 * 
 * Mockito.doReturn(entityDetails).when(entityTopicMap).get(any());
 * Mockito.doReturn(messageByte).when(operations).getMessage(any(), any(),
 ...
 * Mockito.doReturn(updateResult).when(entityService).updateFields(messageByte,
 * updateJsonNode, null); //TODO no assert. no usage of result
 * Mockito.doReturn(updateResult).when(entityService).updateMessage(any(),
 * any(), any()); entityService.updateMessage(any(), "urn:ngsi-ld:Vehicle:A103",
 * updatePayload); verify(entityService, times(1)).updateMessage(any(),
 * any(),any());
 * 
 * 
 * }
