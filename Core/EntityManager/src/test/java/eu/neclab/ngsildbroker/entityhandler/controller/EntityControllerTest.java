 ...
 /**
	 ...
	 */
/*
 * @Test public void createEntityBadRequestTest() { try {
 ...
 * value("Bad Request Data.")); verify(entityService,
 * times(1)).createMessage(any(), any()); } catch (Exception e) {
 ...
 *//**
	 ...
	 */
/*
 * @Test public void createEntity500ExceptionTest() { try {
 ...
 * value("Internal error")); verify(entityService,
 * times(1)).createMessage(any(), any()); } catch (Exception e) {
 * e.printStackTrace(); Assert.fail(); } }
 * 
 *//**
	 ...
	 */
/*
 * @Test public void appendEntityNoContentTest() { try { AppendResult
 * appendResult = Mockito.mock(AppendResult.class);
 * when(entityService.appendMessage(any(), any(), any(),
 * any())).thenReturn(appendResult);
 * when(appendResult.getAppendResult()).thenReturn(true);
 * mockMvc.perform(post("/ngsi-ld/v1/entities/{entityId}/attrs",
 ...
 *//**
	 ...
	 */
/*
 * @Test public void appendEntityMultiStatusTest() { try { AppendResult
 * appendResult = Mockito.mock(AppendResult.class);
 * when(entityService.appendMessage(any(), any(), any(),
 * any())).thenReturn(appendResult);
 * mockMvc.perform(post("/ngsi-ld/v1/entities/{entityId}/attrs",
 ...
 *//**
	 ...
	 */
/*
 * @Test public void appendEntityBadRequestTest() { try {
 * when(entityService.appendMessage(any(), any(), any(), any())) .thenThrow(new
 * ResponseException(ErrorType.BadRequestData));
 * mockMvc.perform(post("/ngsi-ld/v1/entities/{entityId}/attrs",
 * "urn:ngsi-ld:Vehicle:A101")
 * .contentType(AppConstants.NGB_APPLICATION_JSON).accept(AppConstants.
 ...
 *//**
	 ...
	 */
/*
 * @Test public void appendEntityNotFoundTest() { try {
 * when(entityService.appendMessage(any(), any(), any(), any())).thenThrow(new
 ...
 *//**
	 ...
	 */
/*
 * @Test public void appendEntity500Test() { try {
 * when(entityService.appendMessage(any(), any(), any(), any())).thenThrow(new
 * Exception()); mockMvc.perform(post("/ngsi-ld/v1/entities/{entityId}/attrs",
 * "urn:ngsi-ld:Vehicle:A101")
 * .contentType(AppConstants.NGB_APPLICATION_JSON).accept(AppConstants.
 * NGB_APPLICATION_JSONLD)
 ...
 *//**
	 ...
	 */
/*
 * @Test public void updateEntityNoContentTest() { try { UpdateResult
 * updateResult = Mockito.mock(UpdateResult.class);
 * when(entityService.updateMessage(any(), any(),
 * any())).thenReturn(updateResult);
 * when(updateResult.getUpdateResult()).thenReturn(true);
 * mockMvc.perform(patch("/ngsi-ld/v1/entities/{entityId}/attrs",
 * "urn:ngsi-ld:Vehicle:A101")
 * .contentType(AppConstants.NGB_APPLICATION_JSON).accept(AppConstants.
 * NGB_APPLICATION_JSONLD)
 * .content(updatePayload)).andExpect(status().isNoContent());
 * verify(entityService, times(1)).updateMessage(any(), any(), any()); } catch
 ...
 *//**
	 ...
	 */
/*
 * @Test public void updateEntityMultiStatusTest() { try { UpdateResult
 * updateResult = Mockito.mock(UpdateResult.class);
 * when(entityService.updateMessage(any(), any(),
 * any())).thenReturn(updateResult);
 * mockMvc.perform(patch("/ngsi-ld/v1/entities/{entityId}/attrs",
 ...
 *//**
	 ...
	 */
/*
 * @Test public void updateEntityBadRequestTest() { try {
 * when(entityService.updateMessage(any(), any(), any())).thenThrow(new
 * ResponseException(ErrorType.BadRequestData));
 * mockMvc.perform(patch("/ngsi-ld/v1/entities/{entityId}/attrs",
 * "urn:ngsi-ld:Vehicle:A101")
 * .contentType(AppConstants.NGB_APPLICATION_JSON).accept(AppConstants.
 ...
 *//**
	 ...
	 */
/*
 * @Test public void updateEntityNotFoundTest() { try {
 * when(entityService.updateMessage(any(), any(), any())).thenThrow(new
 * ResponseException(ErrorType.NotFound));
 * mockMvc.perform(patch("/ngsi-ld/v1/entities/{entityId}/attrs",
 * "urn:ngsi-ld:Vehicle:A101")
 ...
 *//**
	 ...
	 */
/*
 * @Test public void updateEntity500Test() { try {
 * when(entityService.updateMessage(any(), any(), any())).thenThrow(new
 * Exception()); mockMvc.perform(patch("/ngsi-ld/v1/entities/{entityId}/attrs",
 * "urn:ngsi-ld:Vehicle:A101")
 * .contentType(AppConstants.NGB_APPLICATION_JSON).accept(AppConstants.
 * NGB_APPLICATION_JSONLD)
 ...
 *//**
	 ...
	 */
/*
 * @Test public void partialUpdateAttributeIfDatasetIdExistNoContentTest() { try
 ...
 * mockMvc.perform(patch("/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}",
 * "urn:ngsi-ld:Vehicle:A101", "speed") .with(request -> {
 * request.setServletPath(
 * "/ngsi-ld/v1/entities/urn:ngsi-ld:Vehicle:A101/attrs/speed"); return request;
 * }).contentType(AppConstants.NGB_APPLICATION_JSON).accept(AppConstants.
 * NGB_APPLICATION_JSONLD)
 * .content(partialUpdatePayload)).andExpect(status().isNoContent());
 * verify(entityService, times(1)).partialUpdateEntity(any(), any(), any(),
 * any()); } catch (Exception e) { Assert.fail(); e.printStackTrace(); } }
 * 
 *//**
	 * this method is use for partial update the attribute if datasetId is not exist
	 */
/*
 * @Test public void partialUpdateAttributeIfDatasetIdIsNotExistTest() { try {
 ...
 * .andExpect(jsonPath("$.title").value("Resource not found."));
 * verify(entityService, times(1)).partialUpdateEntity(any(), any(), any(),
 * any()); } catch (Exception e) { e.printStackTrace(); Assert.fail(); } }
 * 
 *//**
	 * this method is validate the bad request in partial update attribute
	 */
/*
 * @Test public void partialUpdateAttributeBadRequestTest() { try {
 * when(entityService.partialUpdateEntity(any(), any(), any(), any()))
 ...
 * "/ngsi-ld/v1/entities/urn:ngsi-ld:Vehicle:A101/attrs/speed"); return request;
 * }) .contentType(AppConstants.NGB_APPLICATION_JSON).accept(AppConstants.
 * NGB_APPLICATION_JSONLD) .with(request -> { request.setServletPath(
 * "/ngsi-ld/v1/entities/urn:ngsi-ld:Vehicle:A101/attrs/speed"); return request;
 * }).content(updatePayload)).andExpect(status().isBadRequest())
 * .andExpect(jsonPath("$.title").value("Bad Request Data."));
 * verify(entityService, times(1)).partialUpdateEntity(any(), any(), any(),
 ...
 *//**
	 ...
	 */
/*
 * @Test public void partialUpdateAttributeDefaultDatasetIdCaseTest() { try {
 * UpdateResult updateResult = Mockito.mock(UpdateResult.class);
 * when(entityService.partialUpdateEntity(any(), any(), any(),
 * any())).thenReturn(updateResult);
 * when(updateResult.getStatus()).thenReturn(true);
 ...
 *//**
	 ...
	 */
/*
 * @Test public void partialUpdateAttributeDefaultDatasetIdCaseNotFoundTest() {
 * try { when(entityService.partialUpdateEntity(any(), any(), any(), any()))
 * .thenThrow(new ResponseException(ErrorType.NotFound));
 * mockMvc.perform(patch("/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}",
 * "urn:ngsi-ld:Vehicle:A101", "speed") .with(request -> {
 * request.setServletPath(
 ...
 * 
 *//**
	 * this method is validate throw the exception in case of partial update
	 * attribute
	 */
/*
 * @Test public void partialUpdateAttribute500Test() { try {
 * when(entityService.partialUpdateEntity(any(), any(), any(),
 ...
 * }) .contentType(AppConstants.NGB_APPLICATION_JSON).accept(AppConstants.
 * NGB_APPLICATION_JSONLD)
 * .content(partialUpdateDefaultCasePayload)).andExpect(status().
 ...
 *//**
	 ...
	 */
/*
 * @Test public void deleteEntityTest() { try {
 * when(entityService.deleteEntity(any(),any())).thenReturn(true);
 * mockMvc.perform(delete("/ngsi-ld/v1/entities/{entityId}",
 * "urn:ngsi-ld:Vehicle:A101")
 * .contentType(AppConstants.NGB_APPLICATION_JSONLD)).andExpect(status().
 * isNoContent()); verify(entityService, times(1)).deleteEntity(any(),any()); }
 * catch (Exception e) { Assert.fail(); e.printStackTrace(); } }
 * 
 *//**
	 ...
	 */
/*
 * @Test public void deleteEntityNotFoundTest() { try {
 * when(entityService.deleteEntity(any(),any())).thenThrow(new
 * ResponseException(ErrorType.NotFound));
 * mockMvc.perform(delete("/ngsi-ld/v1/entities/{entityId}",
 * "urn:ngsi-ld:Vehicle:A101")
 * .contentType(AppConstants.NGB_APPLICATION_JSONLD)).andExpect(status().
 * isNotFound()) .andExpect(jsonPath("$.title").value("Resource not found."));
 * verify(entityService, times(1)).deleteEntity(any(),any()); } catch (Exception
 * e) { Assert.fail(); } }
 * 
 *//**
	 ...
	 */
/*
 * @Test public void deleteEntityBadRequestTest() { try {
 * when(entityService.deleteEntity(any(),any())).thenThrow(new
 * ResponseException(ErrorType.BadRequestData));
 * mockMvc.perform(delete("/ngsi-ld/v1/entities/{entityId}",
 * "urn:ngsi-ld:Vehicle:A101")
 ...
 *//**
	 ...
	 */
/*
 * @Test public void deleteEntity500Test() { try {
 ...
 * any())).thenReturn(true); mockMvc.perform(delete(
 * "/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}?datasetId=urn:ngsi-ld:Property:speedometerA4567-speed",
 * "urn:ngsi-ld:Vehicle:A101", "speed") .with(request -> {
 * request.setServletPath(
 * "/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}?datasetId=urn:ngsi-ld:Property:speedometerA4567-speed\",\r\n"
 * + "					\"urn:ngsi-ld:Vehicle:A101\", \"speed\""); return
 * request; }) .contentType(AppConstants.NGB_APPLICATION_JSONLD))
 * .andExpect(status().isNoContent()); verify(entityService,
 ...
 *//**
	 ...
	 */
/*
 * @Test public void deleteAttributeInstanceIfDatasetIdNotExistTest() { try {
 ...
 * value("Resource not found.")); verify(entityService,
 * times(1)).deleteAttribute(any(), any(), any(), any(), any()); } catch
 * (Exception e) { Assert.fail(); } }
 * 
 *//**
	 ...
	 */
/*
 * @Test public void deleteAttributeInstanceBadRequestTest() { try {
 * when(entityService.deleteAttribute(any(), any(), any(), any(), any()))
 * .thenThrow(new ResponseException(ErrorType.BadRequestData));
 * mockMvc.perform(delete(
 * "/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}?datasetId=urn:ngsi-ld:Property:speedometerA4567-speed",
 ...
 * any()); } catch (Exception e) { Assert.fail(); } }
 * 
 *//**
	 * this method is validate default instance exist in case of delete attribute
	 */
/*
 * @Test public void deleteAttributeDefaultInstanceIfExistTest() { try {
 * when(entityService.deleteAttribute(any(), any(), any(), any(),
 * any())).thenReturn(true); mockMvc.perform(
 * delete("/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}",
 * "urn:ngsi-ld:Vehicle:A101", "speed") .with(request -> { request.
 * setServletPath("/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}\", \"urn:ngsi-ld:Vehicle:A101\", \"speed"
 * ); return request; }) .contentType(AppConstants.NGB_APPLICATION_JSONLD))
 * .andExpect(status().isNoContent()); verify(entityService,
 * times(1)).deleteAttribute(any(), any(), any(), any(), any()); } catch
 * (Exception e) { Assert.fail(); e.printStackTrace(); } }
 * 
 *//**
	 * this method is validate default instance not exist in case of delete
	 * attribute
	 */
/*
 * @Test public void deleteAttributeDefaultInstanceNotExistTest() { try {
 * when(entityService.deleteAttribute(any(), any(), any(), any(), any()))
 * .thenThrow(new ResponseException(ErrorType.NotFound)); mockMvc.perform(
 * delete("/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}",
 * "urn:ngsi-ld:Vehicle:A101", "speed") .with(request -> { request.
 * setServletPath("/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}\", \"urn:ngsi-ld:Vehicle:A101\", \"speed"
 * ); return request; }) .contentType(AppConstants.NGB_APPLICATION_JSONLD))
 ...
 *//**
	 ...
	 */
/*
 * @Test public void deleteAllAttributeInstanceBadRequestTest() { try {
 * when(entityService.deleteAttribute(any(), any(), any(), any(), any()))
 * .thenThrow(new ResponseException(ErrorType.BadRequestData));
 * mockMvc.perform(delete(
 * "/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}?deleteAll=true",
 ...
 * when(entityService.deleteAttribute(any(), any(), any(), any(), any()))
 * .thenThrow(new ResponseException(ErrorType.BadRequestData)); mockMvc.perform(
 * delete("/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}",
 * "urn:ngsi-ld:Vehicle:A101", "speed") .with(request -> { request.
 * setServletPath("/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}\", \"urn:ngsi-ld:Vehicle:A101\", \"speed"
 * ); return request; }) .contentType(AppConstants.NGB_APPLICATION_JSONLD))
 ...
 *//**
	 ...
	 *//*
		 ...
		 * when(entityService.deleteAttribute(any(), any(), any(), any(),
		 * any())).thenThrow(new Exception()); mockMvc.perform(
		 * delete("/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}",
		 * "urn:ngsi-ld:Vehicle:A101", "speed") .with(request -> { request.
		 * setServletPath("/ngsi-ld/v1/entities/{entityId}/attrs/{attrId}\", \"urn:ngsi-ld:Vehicle:A101\", \"speed"
		 * ); return request; }) .contentType(AppConstants.NGB_APPLICATION_JSONLD))
