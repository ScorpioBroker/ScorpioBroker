...
public class EntityJdbcConfig {
	...
	public DataSource getReaderDataSource() {
		return getReaderDataSourceProperties().initializeDataSourceBuilder().type(HikariDataSource.class).build();
	}
	...
	public DataSource getWriterDataSource() {
		return getWriterDataSourceProperties().initializeDataSourceBuilder().type(HikariDataSource.class).build();
	}
