...
//	public static final Gson GSON = DataSerializer.GSON;
	...
	public boolean storeTemporalEntity(String key, String value, String valueWithoutSysAttrs, String valueKV)
			throws SQLException {
		try {
					...
					public Integer doInTransaction(TransactionStatus status) {
						...
						if (entityId != null && attributeId != null) {
							...
							sql = "INSERT INTO " + DBConstants.DBTABLE_TEMPORALENTITY_ATTRIBUTEINSTANCE
									+ " (temporalentity_id, attributeid, data, data_without_sysattrs, kvdata) VALUES (?, ?, ?::jsonb, ?::jsonb, ?::jsonb) ON CONFLICT(temporalentity_id, attributeid, instanceid) DO UPDATE SET data = EXCLUDED.data, data_without_sysattrs = EXCLUDED.data_without_sysattrs, kvdata = EXCLUDED.kvdata";
							tn += writerJdbcTemplateWithTransaction.update(sql, entityId, attributeId, value,
									valueWithoutSysAttrs, valueKV);
