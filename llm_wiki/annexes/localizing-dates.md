...
description: "For example, if a system needs to display DateTime data in Islamic Date format The following request on the proxy: GET /ngsi-ld/v1/entities/urn:ngsi-ld:Event:XXX?attrs=date&format=simplified is forwar"
resource: https://www.etsi.org/deliver/etsi_gs/CIM/001_099/009/01.09.01_60/gs_cim009v010901p.pdf#clause-G.3.1
...
[1] [ETSI GS CIM 009 V1.9.1 clause G.3.1](https://www.etsi.org/deliver/etsi_gs/CIM/001_099/009/01.09.01_60/gs_cim009v010901p.pdf) — Localizing Dates
