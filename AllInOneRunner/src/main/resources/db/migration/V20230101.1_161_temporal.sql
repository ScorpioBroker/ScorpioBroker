...
CREATE OR REPLACE FUNCTION NGSILD_DELETETEMPENTITY (ENTITYID text) RETURNS TABLE (ENDPOINT text, TENANT text, HEADERS jsonb, FORWARDENTITY JSONB, C_ID text) AS $$
declare
	LOCALENTITY jsonb;
	IID bigint;
	i_rec record;
