...
| `app.envs.neo4j.database` |   | neo4j |
| `app.envs.neo4j.host` |   | localhost |
| `app.envs.neo4j.pass` |   | neo4jneo4j |
| `app.envs.neo4j.port` |   | 7687 |
| `app.envs.neo4j.scheme` |   | bolt |
| `app.envs.neo4j.user` |   | neo4j |
| `app.image` | The container image to use. | scorpiobroker/all-in-one-runner:java-kafka-latest |
