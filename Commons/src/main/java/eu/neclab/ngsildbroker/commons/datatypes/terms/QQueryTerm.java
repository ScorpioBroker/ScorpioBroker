...
public class QQueryTerm implements Serializable {
    ...
    public boolean calculate(Map<String, Object> entity, String attribute, String operator, String operant, Set<String> jsonKeys) {
...
//        if (!attribute.matches(URI) && attribute.contains(".")) {
        ...
        if(jsonKeys != null && !jsonKeys.isEmpty()){
            for (String jsonkey : jsonKeys) {
                doNotExpandAttrs.addAll(Arrays.asList(attribute.replaceFirst(jsonkey+"\\[","").split("]")[0].split("\\.")));
            }
        }
