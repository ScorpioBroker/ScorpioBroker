...
public interface NGSIConstants {
	...
	public static final List<String> GEO_KEYWORDS = Arrays.asList(NGSIConstants.GEO_TYPE_POINT, NGSIConstants.GEO_TYPE_POLYGON,
			NGSIConstants.GEO_TYPE_LINESTRING, NGSIConstants.GEO_TYPE_MULTI_POLYGON); //Used in EntryControllerFunctions
