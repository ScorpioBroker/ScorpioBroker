...
class UniqueNamer {
	...
	/**
	 * Creates a new UniqueNamer. A UniqueNamer issues unique names, keeping track
	 * of any previously issued names.
	 *
	...
	/**
	 * Gets the new name for the given old name, where if no old name is given a new
