...
public class JsonLdUtils {
	...
	static boolean isKeyword(Object key) {
		...
		return "@base".equals(key) || "@context".equals(key) || "@container".equals(key) || "@default".equals(key)
				|| "@embed".equals(key) || "@explicit".equals(key) || "@graph".equals(key) || "@id".equals(key)
				|| "@index".equals(key) || "@language".equals(key) || "@list".equals(key) || "@omitDefault".equals(key)
				|| "@reverse".equals(key) || "@preserve".equals(key) || "@set".equals(key) || "@type".equals(key)
				|| "@value".equals(key) || "@vocab".equals(key) || "@requireAll".equals(key) || "@version".equals(key)
				|| "@protected".equals(key) || "@propagate".equals(key) || "@import".equals(key)
				|| "@direction".equals(key) || "@json".equals(key) || "@none".equals(key) || "@included".equals(key)
	...
	/**
	 * Removes the @id member of each node object where the member value is a blank
	 * node identifier which appears only once in any property value within input.
	 *
	 * @param input the framed output before compaction
	 */
	 ...
	 *
	 * @param input   the framed output before compaction
	 * @param toPrune the resulting object.
	 */
	...
	static boolean compareValues(Object v1, Object v2) {
		...
		if (isValue(v1) && isValue(v2)
				&& Obj.equals(((Map<String, Object>) v1).get("@value"), ((Map<String, Object>) v2).get("@value"))
				&& Obj.equals(((Map<String, Object>) v1).get("@type"), ((Map<String, Object>) v2).get("@type"))
				&& Obj.equals(((Map<String, Object>) v1).get("@language"), ((Map<String, Object>) v2).get("@language"))
				&& Obj.equals(((Map<String, Object>) v1).get("@index"), ((Map<String, Object>) v2).get("@index"))) {
			return true;
		}
