...
public class JsonLdOptions {
	 ...
	 *
	 * It will share the same DocumentLoader unless that is overridden, and other
	 * mutable objects, so it isn't immutable.
	 *
	...
	/**
	 * http://www.w3.org/TR/json-ld-api/#widl-JsonLdOptions-processingMode jsonld
	 * 1.1: https://www.w3.org/TR/json-ld11/#dfn-processing-mode
	 */
