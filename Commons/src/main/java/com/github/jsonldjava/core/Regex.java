...
class Regex {
	...
	final public static Pattern PN_PREFIX = Pattern
			.compile("(?:(?:" + PN_CHARS_BASE + ")(?:(?:" + PN_CHARS + "|[\\.])*(?:" + PN_CHARS + "))?)");
	...
	final public static Pattern PN_LOCAL = Pattern.compile("((?:" + PN_CHARS_U + "|[:]|[0-9]|" + PLX + ")(?:(?:"
	...
	final public static Pattern UCHAR = Pattern
			.compile("\\u005Cu" + HEX + HEX + HEX + HEX + "|\\u005CU" + HEX + HEX + HEX + HEX + HEX + HEX + HEX + HEX);
	final public static Pattern ECHAR = Pattern.compile("\\u005C[tbnrf\\u005C\"']");
	final public static Pattern IRIREF = Pattern.compile("(?:<((?:[^\\x00-\\x20<>\"{}|\\^`\\\\]|" + UCHAR + ")*)>)");
	final public static Pattern BLANK_NODE_LABEL = Pattern
			.compile("(?:_:((?:" + PN_CHARS_U + "|[0-9])(?:(?:" + PN_CHARS + "|[\\.])*(?:" + PN_CHARS + "))?))");
	...
	final public static Pattern DOUBLE = Pattern.compile(
