...
public class JsonLdUrl {
	...
	public static String resolve(String baseUri, String pathToResolve) {
		...
		try {
			...
			// URI#resolve drops base scheme for opaque URIs,
			...
			if (uri.isOpaque()) {
				...
				// Drop the last segment, see https://tools.ietf.org/html/rfc3986#section-5.2.3
				// (2nd bullet point)
			...
			if (pathToResolve.startsWith("?")) {
				// drop query, https://tools.ietf.org/html/rfc3986#section-5.2.2: T.query =
				// R.query;
