...
public class Obj {
	...
	public static Object put(Object map, String key1, String key2, String key3, Object value) {
		((Map<String, Object>) ((Map<String, Object>) ((Map<String, Object>) map).get(key1)).get(key2)).put(key3,
				value);
		return map;
	}

	public static Object put(Object map, String key1, String key2, String key3, String key4, Object value) {
		((Map<String, Object>) ((Map<String, Object>) ((Map<String, Object>) ((Map<String, Object>) map).get(key1))
				.get(key2)).get(key3)).put(key4, value);
		return map;
	}
