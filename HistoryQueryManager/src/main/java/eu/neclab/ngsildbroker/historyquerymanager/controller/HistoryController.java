...
public class HistoryController {
    ...
    public Uni<RestResponse<Object>> queryTemporalEntities(HttpServerRequest request, @QueryParam("id") String ids,
                                                           ...
                                                           @QueryParam("timeproperty") String timeProperty,
                                                           @QueryParam("timerel") String timerel,
        ...
        return historyQueryService.query(HttpUtils.getTenant(request), idList, typeQueryTerm, idPattern, attrsQueryTerm,
                qQueryTerm, csfQueryTerm,
                geoQueryTerm, scopeQueryTerm, temporalQueryTerm, aggrTerm, languageQueryTerm, lastN, limit, offset,
                count, localOnly, context).onItem().transform(RestResponse::ok);
    }
